/**
 * Say — Echo text back to sender or group with optional quoted formatting.
 *
 * @module commands/say
 */
...
export default {
    ...
    async handler({ message, rawArgs, sock, pushname }) {
        try {
            ...
            if (!outText) return message.reply("❌ Masukkan teks atau balas pesan teks yang ingin dikirim ulang!");
