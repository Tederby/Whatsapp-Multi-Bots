/**
 * Manga — Search manga, manhwa, and light novels from AniList.
 */
...
export default {
    ...
    usage: "!manga <judul manga/LN> [-t/--top/-1]",
    ...
    async handler({ message, args, cleanArgs, flags, sock, sender, prefix }) {
        ...
        try {
            ...
            if (err.response) {
                ...
                console.error("[MANGA] Response error:", errorMsg, err.response.data);
            } else {
