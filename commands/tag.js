/**
 * Danbooru Tag — Search Danbooru tag dictionary or fetch tags from a quoted Danbooru post.
 *
 * @module commands/tag
 */
...
export default {
    ...
    async handler({ message, sock, args, prefix }) {
        try {
            ...
            await message.reply(`❌ Terjadi kesalahan saat memproses tag: ${err.message}`);
        }
    }
};
